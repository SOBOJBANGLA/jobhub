        ...
        <section class="job-style-two job-list-section pt-100 pb-70">
            <div class="container">
                ...
                <div class="row">
                    ...
                    $sql =$conn->query ("SELECT vacancy.id,vacancy.job_title,vacancy.category,vacancy.salary,vacancy.address,vacancy.last_date,vacancy.job_type FROM vacancy,company WHERE vacancy.company_name='$id' AND vacancy.company_id=company.id");
